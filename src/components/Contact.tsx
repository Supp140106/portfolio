        ...
        <div className="border-border/40 bg-secondary/20 mx-auto max-w-5xl overflow-hidden rounded-[28px] border shadow-xl backdrop-blur-sm">
          <div className="grid md:grid-cols-2">
            <div className="relative p-6 md:p-10" ref={formRef}>
              ...
              >
                <h2 className="from-foreground to-foreground/80 mb-2 bg-gradient-to-r bg-clip-text text-white text-4xl font-bold tracking-tight  md:text-5xl">
                  Contact
                </h2>
                <span className=" relative z-10 w-full text-4xl text-rose-500 font-bold tracking-tight italic md:text-5xl">
                  Me
                </span>
                <SparklesCore
                  id="tsparticles"
